...
public class XUrlMain {
  ...
  public static void main(String[] args) {
    ...
    //System.out.println((xUrl.getUrl(url).equals("http://abc.com")) );
    assert(xUrl.getUrl(url).equals("http://abc.com")); 
    //System.out.println((xUrl.getUrl(url2).equals(xUrl.getUrl(url4))) ); 
    assert(xUrl.getUrl(url2).equals(xUrl.getUrl(url4)));  
    //System.out.println((xUrl.getUrl(url5).equals("http://abc5.com")));
    ...
    //System.out.println((xUrl.getHitCount("http://abc2.com").equals(2)));
     assert(xUrl.getHitCount("http://abc2.com").equals(2));  
    //System.out.println(xUrl.getHitCount("http://abcn.com").equals(0));
